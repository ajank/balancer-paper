...
### GFF
FN.gff.FlyBase     <- "/g/furlong/genome/D.melanogaster/Dm6/6.05/gff/dmel-all-filtered-r6.05.UCSC_names.genes.gff.gz"
FN.sql.reducedGFF  <- paste0(Alek.dir, "/data/gff/dmel-all-filtered-r6.05.UCSC_names.reduced.sqlite")

### Bed files for SVs and enhancers:
Sascha.enhancer.dir <- paste0(Sascha.dir, "/analyses/tracks/enhancer/")
Sascha.tracks.dir <- paste0(Sascha.dir, "/analyses/tracks/")
FN.bed.sv.inv <- paste0(Sascha.tracks.dir, "SVs/INV.bed")
...
### TAD calls (external)
Alek.tad.dir <- paste0(Alek.dir, "/data/hic_annotations/dm6")

### Arc. protein ChIP
Sascha.chip.dir <- paste0(Sascha.dir, "/analyses/tracks/TADs/chipData/")
...
### RNA tracks
Sascha.rna.dir <- paste0(Sascha.dir, "/analyses/ase/tracks/rna/")
